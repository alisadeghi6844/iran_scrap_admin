...
export const getLast10DaysRange = () => {
  const today = moment();
...
export const buildProductPriceFilterQuery = (data: unknown) => {
  ...
  // NOTE: Provider is intentionally not included to preserve current behavior.
  void Provider;
